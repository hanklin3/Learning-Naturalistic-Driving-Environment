...
class Trainer(object):
    ...
    def _load_checkpoint(self):
        ...
        if os.path.exists(os.path.join(self.checkpoint_dir, 'last_ckpt.pt')):
            print('loading last checkpoint...', os.path.join(self.checkpoint_dir, 'last_ckpt.pt'))
    ...
    def _sampling_from_mu_and_std1(self, mu, std, heading_mu):
        ...
        with torch.no_grad():
            ...
            # Concatenate the latitude, longitude, and heading_mu tensors
            result = torch.cat([lat, lon, heading_mu], dim=-1)
